...
# Test & interaction
TestNum = 100000             # Number of tests
...
for t in range(TestNum):
    ...
    for con in range(ContectNum):
        ...
        fit_C = Compute_fitness(i, strategy, b, c) * strategy[i] + Compute_fitness(selected_v, strategy, b, c) * strategy[selected_v]
        fit_total = Compute_fitness(i, strategy, b, c) + Compute_fitness(selected_v, strategy, b, c)
